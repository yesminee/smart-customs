                    ...
                    <form action="#" method="POST">
                      ...
                      <div class="flex w-full space-x-2">
                        <div class="w-1/2">
                          ...
                          ></MDBInput>
                          <br />
                          <span v-if="erreur.nom" class="text-red-700"
                        ...
                        <div class="w-1/2">
                          ...
                          ></MDBInput>
                          <br />
                          <span v-if="erreur.prenom" class="text-red-700"
                            >Ce champ est obligatoire</span
                          >
                        </div>
                      </div>
                      ...
                      <div class="flex w-full space-x-2">
                        <div class="w-1/2">
                          ...
                          <span v-if="erreur.CIN1" class="text-indigo-700"
                            >Ce champ est obligatoire</span
                          >
                          <br />
                          <span v-if="erreur.CIN2" class="text-indigo-700">
                        ...
                        <div class="w-1/2">
                          ...
                          ></MDBInput>
                          <span v-if="erreur.numeroTel1" class="text-indigo-700"
                            >Ce champ est obligatoire</span
                          >
                          <br />
                          <span
                      ...
                      <div>
                        ...
                        <span class="text-red-700" v-if="erreur.email1">
                          Ce champ ne ressemble pas à une adresse e-mail valide
                        </span>
                      </div>
                      ...
                      <div class="flex space-x-2 mt-4">
                        <div>
                          ...
                          ></MDBInput>
                          <br />
                          <span v-if="erreur.nomEntreprise" class="text-red-700"
                            >Ce champ est obligatoire.</span
                          >
                        </div>
                        <div>
                          ...
                          ></MDBInput>
                          <br />
                          <span v-if="erreur.capitalSocial" class="text-red-700"
                            >Ce champ est obligatoire.</span
                          >
                        </div>
                        <br />
                      ...
                      <div class="flex w-full space-x-2 mt-3">
                        <div class="w-1/2">
                          ...
                          <input
                            ...
                            "
                          />
                          <span v-if="erreur.dateDebAct" class="text-red-700"
                            >Ce champ est obligatoire</span
                          >
                        </div>
                        <br />
                        <div class="w-1/2">
                          ...
                          <input
                            ...
                            "
                          />
                          <span v-if="erreur.datePub" class="text-red-700"
                            >Ce champ est obligatoire</span
                          >
                        </div>
                      </div>
                      <div class="flex w-full space-x-2 mt-4">
                        <div class="w-1/2">
                          ...
                          ></MDBInput>
                          <br />
                          <span v-if="erreur.actPrincipale" class="text-red-700"
                            >Ce champ est obligatoire.</span
                          >
                        </div>
                        <br />
                        <div class="w-1/2">
                          ...
                          ></MDBInput>
                          <br />
                          <span v-if="erreur.actSecondaire" class="text-red-700"
                            >Ce champ est obligatoire</span
                          >
                        </div>
                      </div>
...
async function enregistrer() {
  ...
  if (
    user.value.numeroTel.length != 8 ||
    isNaN(parseInt(user.value.numeroTel))
  ) {
    erreur.value.numeroTel = true;
